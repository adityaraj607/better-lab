  ...
  return server ? (
    <select
      ...
      <optgroup label="Ramapuram">
        <option value="rmpetelab2025">RMP 2025</option>
        <option value="rmpetelab2024">RMP 2024</option>
      ...
      <optgroup label="Vadapalani">
        <option value="vdpetelab2025">VDP 2025</option>
        <option value="vdpetelab2024">VDP 2024</option>
